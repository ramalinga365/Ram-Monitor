<template>
    <div>
        ...
        <div v-if="installed" class="mb-2">
            <div class="mb-4">
                ...
                <div class="form-text">
                    ...
                    <a href="https://github.com/ramalinga365/Ram-Monitor/wiki/Reverse-Proxy-with-Cloudflare-Tunnel" target="_blank">
                        https://github.com/ramalinga365/Ram-Monitor/wiki/Reverse-Proxy-with-Cloudflare-Tunnel
                    </a>
                </div>
            </div>
        ...
        <div>
            ...
            {{ $t("Please read") }} <a href="https://github.com/ramalinga365/Ram-Monitor/wiki/Reverse-Proxy" target="_blank">https://github.com/ramalinga365/Ram-Monitor/wiki/Reverse-Proxy</a>.
        </div>
